...
struct MenuView: View {
    var body: some View {
        VStack {
            ...
            .frame(height: 300)
            .background(LinearGradient(gradient: Gradient(colors: [Color.white, Color(#colorLiteral(red: 0.9607843137, green: 0.9725490196, blue: 1, alpha: 1))]), startPoint: .top, endPoint: .bottom)
            )
